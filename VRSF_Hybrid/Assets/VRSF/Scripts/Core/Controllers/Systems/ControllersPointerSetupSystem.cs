...
namespace VRSF.Core.Controllers
{
    ...
    /// </summary>
    public class ControllersPointerSetupSystem : ComponentSystem
    {
        struct Filter
        {
        ...
        private void Init(OnSetupVRReady setupVRReady)
        {
            ...
            foreach (var e in GetEntities<Filter>())
            {
                ...
                bool isUsingController = VRSF_Components.DeviceLoaded != EDevice.SIMULATOR && controllersParameters.UseControllers &&
                    ((e.RaycastComp.RayOrigin == ERayOrigin.LEFT_HAND && controllersParameters.UsePointerLeft) || (e.RaycastComp.RayOrigin == ERayOrigin.RIGHT_HAND && controllersParameters.UsePointerRight));

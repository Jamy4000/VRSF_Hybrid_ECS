...
namespace VRSF.Inputs.Systems
{
    ...
    /// </summary>
    public class OVRRightControllerInputCaptureSystem : ComponentSystem
    {
        struct Filter
        {
            public OVRControllersInputCaptureComponent VRInputCapture;
        }
        ...
        /// </summary>
        void CheckRightControllerInput(OVRControllersInputCaptureComponent vrInputCapture)
        {

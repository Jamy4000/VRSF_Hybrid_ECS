            ...
            switch (entity.BACGeneral.ButtonHand)
            {
                case (EHand.LEFT):
                    ...
                    if (ControllersParametersVariable.Instance.UsePointerLeft)
                        entity.PointerObjects._ControllersPointer = VRSF_Components.LeftController.GetComponent<LineRenderer>();
                    break;
                ...
                case (EHand.RIGHT):
                    ...
                    if (ControllersParametersVariable.Instance.UsePointerRight)
                        entity.PointerObjects._ControllersPointer = VRSF_Components.RightController.GetComponent<LineRenderer>();
                    break;
